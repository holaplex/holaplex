...
export function ListingPreview(props: Listing) {
  ...
  if (!props.metadata) return <SkeletonListing />;
  ...
  return !props.address ? (
    ...
    <ListingPreviewContainer>
      <Square>
        <NFTPreview
          ...
          preview={{
            ...
            // getContainer: 'helloContainer',
            // onVisibleChange: (visible, prevVisible) => {
            //   console.log('visible', visible);
            //   console.log('prev visible', prevVisible);
            //   setShowArtPreview(!prevVisible);
            // },
            // destroyOnClose: true,
          }}
      ...
      <Row justify="space-between">
        <ListingTitle>{metadata.name}</ListingTitle>
      ...
      <Row justify="space-between">
        ...
        {props.endsAt ? <AuctionCountdown endTime={props.endsAt} /> : <span>Buy now</span>}
      </Row>
      <style jsx>
        {`
          .truncate {
