...
export type FeaturedCollectionsByVolumeData = CollectionPreviewCardData[];

export interface FeaturedCollectionsByVolumeSectionProps {
  context: QueryContext<FeaturedCollectionsByVolumeData>;
}

export function FeaturedCollectionsByVolumeSection(props: FeaturedCollectionsByVolumeSectionProps) {
  ...
  return (
    <HomeSection>
      <HomeSection.Header>
        <HomeSection.Title>Top volume collections</HomeSection.Title>
        <HomeSection.HeaderAction href="/discover/collections?by=volume">
          See all
