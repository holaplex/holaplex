...
const BUTTON_DISABLED_CLASSES = {
  primary:
    'rounded-full bg-white px-6 py-2 text-base font-medium text-gray-500 bg-gray-300',
  secondary:
    'rounded-full bg-gray-800 px-6 py-2 text-base font-medium bg-gray-700 text-gray-400',
  ghost:
