  ...
  return (
    <div className="w-full space-y-4 text-base">
      <div className="sticky top-0 z-10 flex w-full flex-col items-center gap-6 bg-gray-900 bg-opacity-80 py-4 backdrop-blur-sm lg:flex-row lg:justify-between lg:gap-4">
        <div
          className={classNames(['flex space-x-4', 'lg:justify-end'], 'w-full px-6', 'md:px-20')}
        >
          {props.filters && (
      ...
      <div className={classNames('flex', 'px-6 md:px-20')}>
        {props.filters && (
          <FiltersSection
            collapsed={collapsed}
...
export function CardGrid<T>(props: CardGridProps<T>): JSX.Element {
  ...
  return (
    <>
      <div className={classNames('grid grid-cols-1 gap-6', gridViewClasses, props.className)}>
